...
module.exports = (app, upload) => {
	...
	app.get(
		"/emsp/api/v1/locations/unbinded",
		[
			tokenMiddleware.AccessTokenVerifier(),
			roleMiddleware.CheckRole(
				ROLES.ADMIN,
	...
	app.get(
		"/emsp/api/v1/locations/:cpo_owner_id",
		[
			tokenMiddleware.AccessTokenVerifier(),
			roleMiddleware.CheckRole(
				ROLES.ADMIN,
	...
	app.patch(
		"/emsp/api/v1/locations/:action/:location_id/:cpo_owner_id",
		[
			tokenMiddleware.AccessTokenVerifier(),
			roleMiddleware.CheckRole(
				ROLES.ADMIN,
	...
	app.get(
		"/emsp/api/v1/locations/data/defaults",
